...
class Trie:
    ...
    def add(self, word_to_add):
        ...
        Returns
        -------
        Boolean indicating that if the insertion is successful
            or not. Returns false if the word is already in the trie
    ...
    def delete(self, word_to_delete):
        ...
        Returns
        -------
        Boolean indicating that if the deletion is successful or not.
