class TrieNode:
    ...
    :param is_complete_word: A boolean value marks if the path to this node forms a complete word
    :param children: A dictionary that maps from the next alphabet to the corresponding sub-tree. Can be None if this
        node is a leaf
    """
