...
def test_add():
    """
    this test function tests if the add function will return
        True when adding a new word
    """
    trie = Trie()
    assert trie.add("hello")


def test_add_existing_word():
    """
    this test function tests if the add function will return
        False when adding an existing word
    """
    trie = Trie()
    trie.add("hello")
    assert not trie.add("hello")


def test_add_word_is_string():
    """
    this test function tests if the add function will give a TypeError
        when inserting something other than a string
    """
    trie = Trie()
...
def test_add_empty_string():
    """
    this test function tests if the add function will give a
        ValueError when inserting an empty string
    """
    trie = Trie()
...
def test_add_sucessfully_creates_new_node():
    """
    this test function tests if the add function will correctly create
        a new node when adding a word
    """
    trie = Trie()
...
def test_add_to_existing_node():
    """
    this test function tests if the add function will correctly add
        a word to an existing child node
    """
    trie = Trie()
