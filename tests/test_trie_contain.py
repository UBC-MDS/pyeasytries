...
def test_contain_report_error_on_invalid_argument_type():
    """
    This test creates an empty trie and test if the function will
        throw a `TypeError` when inputting an integer.
    """
    trie = Trie()
...
def test_contain_report_error_on_invalid_word():
    """
    This test creates an empty trie and test if the function will
        throw a `ValueError` when the input word contains numbers
        or symbols.
    """
    trie = Trie()
